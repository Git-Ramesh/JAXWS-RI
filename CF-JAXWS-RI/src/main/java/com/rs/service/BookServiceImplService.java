 ...
 * 
 */
@WebServiceClient(name = "BookServiceImplService", targetNamespace = "http://service.rs.com", wsdlLocation = "file:/D:/Eclipse%20Workspace/WebServices-20190428/CF-JAXWS-RI/src/main/webapp/WEB-INF/wsdl/BookService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BOOKSERVICEIMPLSERVICE_QNAME = new QName("http://service.rs.com", "BookServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/D:/Eclipse%20Workspace/WebServices-20190428/CF-JAXWS-RI/src/main/webapp/WEB-INF/wsdl/BookService.wsdl");
    ...
    public BookService getBookServiceImplPort() {
        return super.getPort(new QName("http://service.rs.com", "BookServiceImplPort"), BookService.class);
    }
    ...
    public BookService getBookServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.rs.com", "BookServiceImplPort"), BookService.class, features);
    }
